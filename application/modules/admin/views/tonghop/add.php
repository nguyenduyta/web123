...
<div class="header">
    ...
    <span style="float:right; margin-right:15px;">
    	<ul id="control" style="margin:0px; padding:0px; list-style:none;">
            <li><a href="<?php echo base_url('admin/tonghop') ?>" title="Back">Quay lại</a></li>
        </ul>
    </span>
</div>
<br class="clear"/>
<div class="content" style="min-height:400px;">
    <div class="gt">
		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
                <tr>
                	<td width="125"><label>Chuyên mục đăng (<span class="require">*</span>)</label></td>
                    <td>
                        <select name="post">
                            <option value="">Chọn chuyên mục đăng</option>
                            <option value="1">PHP căn bản</option>
                            <option value="2">PHP nâng cao</option>
                            <option value="3">PHP Framework</option>
                        </select>
				...
				<tr>
                    ...
                    <td>
                        <input type="text" id="news_name"  name="news_name" value="<?php if(isset($_POST['news_name'])) echo $_POST['news_name']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="news_author"  name="news_author" value="<?php if(isset($_POST['news_author'])) echo $_POST['news_author']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="meta" style="width: 600px; height: 50px;"></textarea>
                    </td>
				</tr>
                <tr>
                	<td width="125"><label>Key</label></td>
                    <td>
                        <textarea name="key" style="width: 600px; height: 50px;"></textarea>
                    </td>
				</tr>
                <tr>
                    <td>&nbsp;</td>
