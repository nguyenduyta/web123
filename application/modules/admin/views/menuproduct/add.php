                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            $attr   = array('size'=> 25, 'style'=> 'width: 460px');
                ...
                <tr>
                    ...
                    <td>
                        <select name="group" id="group">
                            ...
                            <option value="spck" <?php if(isset($_POST['group']) && $_POST['group'] == 'spck') echo 'selected="selected"'; ?>>Sản phẩm cơ khí</option>
                            <option value="tbd" <?php if(isset($_POST['group']) &&  $_POST['group'] == 'tbd') echo 'selected="selected"'; ?>>Thiết bị điện</option>
                            <option value="tbvp" <?php if(isset($_POST['group']) &&  $_POST['group'] == 'tbvp') echo 'selected="selected"'; ?>>Thiết bị văn phòng</option>
                            <option value="dctt" <?php if(isset($_POST['group']) &&  $_POST['group'] == 'dctt') echo 'selected="selected"'; ?>>Dụng cụ thể thao</option>
                        </select>
