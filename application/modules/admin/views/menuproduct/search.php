    	...
    	<div class="content">
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tbody>
                        <?php 
                            $stt = 1;
                            foreach($menuproduct as $key=>$val) {
                                $id = $val['id'];
                                $name = $val['name'];
                                $active = $val['active'];
                                $parent = $val['parent'];
					...
					<tr  class="class_jpage">
                        ...
                        <td align="center"><input type="text" name="order[<?php echo $val['id'] ?>]" id="order" value="<?php echo $order; ?>" size="2" /></td>
