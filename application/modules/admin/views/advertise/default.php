    <div class="onecolumn">    	
        ...
        <div class="frmSearch" style="padding: 8px; clear: both;">
            <form action="<?php echo base_url('admin/advertise/search') ?>" method="post" name="formSearch" id="formSearch"  class="formSearch">
                <input type="text" size="45" name="keyword" id="keyword" value="<?php if(isset($_POST['keyword'])) echo $_POST['keyword']; else echo 'Nhập tên khách hàng cần tìm'; ?>" onblur="clearText(this)" onfocus="clearText(this)" />
    	...
    	<div class="content">
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						<th style="width:3%" style="vertical-align: middle;"><input type="checkbox" id="check_all" name="check_all"></th>
						<th style="width:3%" style="vertical-align: middle;">STT</th>
						<th style="width:3%">Hình ảnh</th>
				...
				<tbody>
					...
					<tr class="class_jpage">
                        ...
                        <input type="checkbox" name="cid[]" id="cid" class="item" value="<?php echo $val['id'] ?>">
                        </td>
						<td align="center" style="vertical-align: middle;"><?php echo $i++ ?></td>
						<td align="center">
                            <img src="<?php echo $val['adsfile'] ?>" width="100" />
                        </td>
                        ...
                        <td align="center" style="vertical-align: top;"><?php echo date('d-m-Y', $val['date']) ?></td>
						<td align="center" style="vertical-align: top;">
