		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
                    ...
                    <td>
                        <input type="text" id="pname"  name="pname" value="<?php echo $product['pname']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <select name="active" id="active">
                            <option value="1" <?php if($product['pactive'] == 1) echo 'selected="selected"'; ?>>Hiển thị</option>
                            <option value="0" <?php if($product['pactive'] == 0) echo 'selected="selected"'; ?>>Không hiển thị</option>
                        </select>
                    </td>
				</tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="porder" value="<?php echo $product['meta']; ?>" size="80"  name="meta" value="<?php if(isset($_POST['meta'])) echo $_POST['meta']; ?>"  size="20" /> (Tùy chọn)
                        <?php echo form_error('porder') ?>
                    </td> 
				</tr>
                <tr>
                    ...
                    <td>
                        <input type="text" id="porder" value="<?php echo $product['key']; ?>" size="80"  name="key" value="<?php if(isset($_POST['key'])) echo $_POST['key']; ?>"  size="20" /> (Tùy chọn)
                        <?php echo form_error('porder') ?>
                    </td> 
				</tr>
		        <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="submit" name="btnAdd" value="Cập nhật" />
