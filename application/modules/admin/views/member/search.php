    <div class="onecolumn">
        <div class="header">
            ...
            <ul id="control">
                ...
                <li><input type="submit"  onclick="actionDelete('form_data')" name="deleteall" value="&nbsp;" title="Xóa tất cả" /></li>
            </ul>
    	</div>
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr class="class_jpage">
						<td align="center" style="vertical-align: middle;"><input type="checkbox" name="cid[]" id="cid" class="item" value="<?php echo $listuser['user_id']; ?>"></td>
                        ...
                        <?php 
                            switch($listuser['user_level']){
                                case 2: echo "<font color='red'>Administrator</font>";break;
                                case 3: echo "Moderator";break;
                                case 4: echo "Bình thường";break;   
                            }
                        ?>
                        </td>
                        <td align="center" style="vertical-align: middle;">
