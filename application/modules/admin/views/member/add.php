...
<div class="content" style="min-height:400px;">
    <div class="gt">
    	<form id="form_data" name="form_data" method="post" enctype="multipart/form-data">
		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
			    <tr>
                    ...
                    <td>
                        <input type="text" id="user_name"  name="user_name" value="<?php if(isset($_POST['user_name'])) echo $_POST['user_name']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="user_email"  name="user_email" value="<?php if(isset($_POST['user_email'])) echo $_POST['user_email']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="fullname"  name="fullname" value="<?php if(isset($_POST['fullname'])) echo $_POST['fullname']; ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                   	    <select name="user_sex">
        					<option value="1" <?php if(isset($_POST['user_sex']) &&  $_POST['user_sex'] == 1) echo 'selected="selected"' ?>>Nam</option>
        					<option value="0" <?php if(isset($_POST['user_sex']) &&  $_POST['user_sex'] == 0) echo 'selected="selected"' ?>>Nữ</option>
            	       </select>
                    </td>
				</tr> 
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_address" size="45" class="input" value="<?php if(isset($_POST['user_address'])) echo $_POST['user_address']; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_phone" size="45" class="input" value="<?php if(isset($_POST['user_phone'])) echo $_POST['user_phone']; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_mobile" size="45" class="input" value="<?php if(isset($_POST['user_mobile'])) echo $_POST['user_mobile']; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_yahoo" size="45" class="input" value="<?php if(isset($_POST['user_yahoo'])) echo $_POST['user_yahoo']; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_skype" size="45" class="input" value="<?php if(isset($_POST['user_skype'])) echo $_POST['user_skype']; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                   	    <input type="text" name="user_facebook" size="45" class="input" value="<?php if(isset($_POST['user_facebook'])) echo $_POST['user_facebook']; ?>"/>
                    ...
                    <td>
               	        <select name="user_level" id="user_level">
                            ...
                            <?php if(isset($_POST['user_level']) && $_POST['user_level'] == $val1['id']) { ?>
                                <option value="<?php echo $val1['id'] ?>" selected="selected"><?php echo $val1['name'] ?></option>
                                <?php } else { ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="user_order"  name="user_order" value="<?php if(isset($_POST['user_order'])) echo $_POST['user_order']; else {echo 1;} ?>" size="3"  />
                ...
                <tr>
                    ...
                    <td>
                        <select name="user_active" id="user_active">
                            <option value="1" <?php if(isset($_POST['user_active']) && $_POST['user_active'] == 1) echo 'selected="selected"'; ?>>Hiển thị</option>
                            <option value="0" <?php if(isset($_POST['user_active']) && $_POST['user_active'] == 0) echo 'selected="selected"'; ?>>Không hiển thị</option>
                        </select>
                    </td>
				</tr>
