    <div class="onecolumn">
        ...
        <div class="frmSearch" style="padding: 8px; clear: both;">
            <form action="<?php echo base_url('admin/brand/search') ?>" method="post" name="formSearch" id="formSearch"  class="formSearch">
                <input type="text" size="45" name="keyword" id="keyword" value="<?php if(isset($_POST['keyword'])) echo $_POST['keyword']; else echo 'Nhập tên hãng cần tìm'; ?>" onblur="clearText(this)" onfocus="clearText(this)" />
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr class="class_jpage">
						<td align="center" style="vertical-align: middle;"><input type="checkbox" name="cid[]" id="cid" class="item" value=""></td>
                        ...
                        <td align="center"><input type="text" name="brandorder" size="3" id="brandorder" size="3"  value="<?php echo $val['brandorder'] ?>"/></td>
