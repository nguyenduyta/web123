		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
                    ...
                    <td>
                        <input type="text" id="brandname"  name="brandname" value="<?php if(isset($_POST['brandname'])) echo $_POST['brandname']; else echo $brand['brandname'] ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="brandorder"  name="brandorder" value="<?php if(isset($_POST['brandorder'])) echo $_POST['brandorder']; else echo $brand['brandorder'] ?>" size="3"  />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="brandimage"  name="brandimage" value="<?php if(isset($_POST['brandimage'])) echo $_POST['brandimage']; else echo $brand['brandimage'] ?>" size="40"  />
                ...
                <tr>
                    ...
                    <td>
                        <select name="brandactive" id="brandactive">
                            <option value="1" <?php if($brand['brandactive'] == 1) echo 'selected="selected"'; elseif(isset($_POST['brandactive']) && $_POST['brandactive'] == 1) echo 'selected="selected"';  ?>>Hiển thị</option>
                            <option value="0" <?php if($brand['brandactive'] == 0) echo 'selected="selected"'; elseif(isset($_POST['brandactive']) && $_POST['brandactive'] == 0) echo 'selected="selected"';  ?>>Không hiển thị</option>
                        </select>
                    </td>
				</tr>
                <tr>
