		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                       <textarea cols="60" rows="8" name="link" id="link"><?php if(isset($_POST['link'])) echo $_POST['link'];?></textarea><br />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="3" value="<?php if(isset($_POST['width'])) echo $_POST['width']; else echo 250;?>" name="width" /> (px)
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="3" value="<?php if(isset($_POST['height'])) echo $_POST['height']; else echo 250;?>" name="height" /> (px)
