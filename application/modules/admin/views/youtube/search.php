			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tbody>
					...
					<tr class="class_jpage">
                        ...
                        <td align="center" style="vertical-align: middle;"><iframe width="<?php echo $val['width'] ?>" height="<?php echo $val['height'] ?>" src="http://www.youtube.com/embed/<?php echo $val['link']?>" frameborder="0" allowfullscreen></iframe></td>
