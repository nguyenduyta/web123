		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input type="radio" name="charge"  value="div2" checked="checked"/> Không
                            <input type="radio" name="charge"  value="div1"  />Có
                        </div>
                        <div class="clear"></div>
                        <div id="div1" class="opt">
                            <input type="text" id="price" name="price" size="15"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="file"  name="file" value="" size="40"  />
