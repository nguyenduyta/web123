...
<div class="header">
    ...
    <span style="float:right; margin-right:15px;">
    	<ul id="control" style="margin:0px; padding:0px; list-style:none;">
        	<li><a href="#"></a></li>
            <li><a href="<?php echo base_url('admin/post') ?>" title="Back">Quay lại</a></li>
        </ul>
    </span>
</div>
<br class="clear"/>
                    ...
                    <td>
                        <select name="posttype" id="posttype">
                            ...
                            <?php foreach($posttype as $key=>$val) { ?>
                                <?php if($post['posttype'] == $val['id']) { ?>
                                <option  value="<?php echo $val['id'] ?>" selected="selected"><?php echo $val['nametype'] ?></option>
                                <?php } else { ?>
