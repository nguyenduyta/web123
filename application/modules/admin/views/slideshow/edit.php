		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
                    ...
                    <td>
                        <input type="text" id="name"  name="name" value="<?php if(isset($_POST['name'])) echo $_POST['name']; else echo $slideshow['name'] ?>"  size="45" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="order"  name="order" value="<?php if(isset($_POST['order'])) echo $_POST['order']; else echo $slideshow['order']; ?>" size="3"  />
                        <?php echo form_error('order') ?>    
                    </td>
				</tr>
                <tr>
                    <td width="125" style="vertical-align: top;"><label>Ảnh hiện tại </label></td>
                    <td>
                        <img width="400" src="<?php echo $slideshow['image'] ?>" alt="<?php echo $slideshow['name'] ?>" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="image"  name="image" value="<?php echo $slideshow['image'] ?>" size="40"  />
                ...
                <tr>
                    ...
                    <td>
                        <select name="active" id="active">
                            <option value="1" <?php if($slideshow['active'] == 1) echo 'selected="selected"'; elseif(isset($_POST['active']) && $_POST['active'] == 1) echo 'selected="selected"';  ?>>Hiển thị</option>
                            <option value="0" <?php if($slideshow['active'] == 0) echo 'selected="selected"'; elseif(isset($_POST['active']) && $_POST['active'] == 0) echo 'selected="selected"';  ?>>Không hiển thị</option>
                        </select>
                    </td>
				</tr>
                <tr>
