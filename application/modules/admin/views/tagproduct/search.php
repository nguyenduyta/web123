    <div class="onecolumn">
        <div class="header">
            ...
            <ul id="control">
                <li><a href="<?php echo base_url('admin/tagproduct/add') ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_add_big.png" alt="Thêm danh mục" title="Thêm danh mục" /></a></li>
        ...
        <div class="frmSearch" style="padding: 8px; clear: both;">
            <form action="<?php echo base_url('admin/tagproduct/search') ?>" method="post" name="formSearch" id="formSearch"  class="formSearch">
                <input type="text" size="45" name="keyword" id="keyword" value="<?php if(isset($_POST['keyword'])) echo $_POST['keyword']; else echo 'Nhập tiêu đề Tag sản phẩm cần tìm'; ?>" onblur="clearText(this)" onfocus="clearText(this)" />
    	...
    	<div class="content">
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tbody>
                    <?php $stt = 1 ?>
                    <?php foreach($tagproduct as $key=>$val) { ?>
					<tr class="class_jpage">
                        ...
                        <td align="center" style="vertical-align: middle;">
                            <?php if($val['active'] == 1) { ?>
                                <a href="<?php echo base_url('admin/tagproduct/status/inactive/id/'.$val['id']) ?>"><img class="status" src="<?php echo base_url() ?>public/admin/images/active.png" alt="Kích hoạt" title="Hiển thị" /></a>
                            <?php } else { ?>
                                <a href="<?php echo base_url('admin/tagproduct/status/active/id/'.$val['id']) ?>"><img class="status" src="<?php echo base_url() ?>public/admin/images/deactive.png" alt="Không kích hoạt" title="Hiển thị" /></a>
                            <?php } ?>
                        </td>
						...
						<td align="center">
							<a href="<?php echo base_url('admin/tagproduct/edit/'.$val['id']) ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_edit.png" alt="edit" class="help" title="Edit"></a>
							<a href="<?php echo base_url('admin/tagproduct/delete/'.$val['id']) ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_delete.png" alt="delete" class="help" title="Delete"></a>
						</td>
					</tr>
                    <?php } ?>
				</tbody>
