    <div class="onecolumn">
        <div class="header">
            ...
            <ul id="control">
                <li><a href="<?php echo base_url('admin/suntech/add') ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_add_big.png" alt="Thêm danh mục" title="Thêm danh mục" /></a></li>
        ...
        <div class="frmSearch" style="padding: 8px; clear: both;">
            <form action="<?php echo base_url('admin/suntech/search') ?>" method="post" name="formSearch" id="formSearch"  class="formSearch">
    	...
    	<div class="content">
			...
			<table class="data" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr class="class_jpage">
						...
						<td align="center" style="vertical-align: middle;">
							<a href="<?php echo base_url('admin/suntech/edit/'.$val['id']) ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_edit.png" alt="Sửa" class="help" title="Sửa"></a>
							<a href="<?php echo base_url('admin/suntech/delete/'.$val['id']) ?>"><img src="<?php echo base_url() ?>public/admin/images/icon_delete.png" alt="Xóa" class="help" title="Xóa"></a>
						</td>
					</tr>
                    <?php } ?>
				</tbody>
