		...
		<table class="data" width="100%" cellpadding="0" cellspacing="0">
			<tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" id="nametype"  name="nametype" value="<?php if(isset($info)){ echo $info['name']; } ?>" size="48"  />
                ...
                <tr>
                	<td width="125"><label>&nbsp;</label></td>
                    <td>
                        <img src="<?php echo base_url() ?>uploads/product/product/<?php echo $info['img']; ?>" width="100" />
                    </td>
				</tr>
                <tr>
                    <td>&nbsp;</td>
