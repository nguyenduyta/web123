...
/**
 *Class Folder:
 *  function load($folder = './', $reject = ''): Load folder in $folder
 *  function count($folder = './', $reject = ''): Total count folder in $folder
 *  function size($path = './'): Dimension Path
 *  function format($size = 0): Format Bytes, KB, MB, GB
**/
class Folder
{
